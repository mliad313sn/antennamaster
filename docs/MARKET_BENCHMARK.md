...
| **Price / hosting** | **$0, open source (AGPL-3.0), self-hosted**; runs fully offline/air-gapped (PWA + local basemap/DEM caches); installers for Linux/macOS/Windows | Contact-sales; options (Aster, In-Building) licensed separately | Contact-sales; perpetual or subscription; USB-dongle/VM modes | Contact-sales | Contact-sales | Contact-sales |
