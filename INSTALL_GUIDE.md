...
| OS | Install | Launch |
|---|---|---|
| **Windows (one-click)** | run **`dist/AntennaMaster-Setup-1.3.2.exe`** | Start menu → **AntennaMaster** |
...
`dist/AntennaMaster-Setup-1.3.2.exe` is a signed-format NSIS installer built
