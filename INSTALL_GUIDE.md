...
| OS | Install | Launch |
|---|---|---|
| **Windows (one-click)** | run **`dist/AntennaMaster-Setup-1.2.0.exe`** | Start menu → **AntennaMaster** |
...
`dist/AntennaMaster-Setup-1.2.0.exe` is a signed-format NSIS installer built
